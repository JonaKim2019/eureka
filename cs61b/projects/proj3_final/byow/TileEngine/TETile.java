...
public class TETile implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        return character == otherTile.character
                && textColor.equals(otherTile.textColor)
                && backgroundColor.equals(otherTile.backgroundColor)
                && description.equals(otherTile.description);
    }
    @Override
    public int hashCode() {
        return Character.hashCode(character) + textColor.hashCode() * 10
                + backgroundColor.hashCode() * 100 + description.hashCode() * 1000;
    }

    public TETile insertWall() {
